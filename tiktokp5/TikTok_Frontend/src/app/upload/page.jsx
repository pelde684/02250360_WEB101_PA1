...
const UploadPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await uploadVideo(videoFile, thumbnailFile, caption, (percent) => {
        setUploadProgress(percent);
        toast.loading(`Uploading video... ${percent}%`, { id: uploadToast });
      });
            ...
            <div className="flex flex-col">
              ...
              {thumbnailPreview ? (
                <div className="mb-4 aspect-video w-full overflow-hidden rounded-lg bg-gray-100">
                  <img src={thumbnailPreview} alt="Thumbnail preview" className="h-full w-full object-contain" />
                </div>
              ) : (
                <div
                ...
                >
                  ...
                  <p className="text-center text-gray-500">
                    Click to upload a thumbnail<br />
            ...
            <div>
              ...
              {uploading && (
                <div className="mb-4">
                  ...
                  <p className="mt-1 text-center text-xs text-gray-500">Uploading: {uploadProgress}%</p>
                </div>
              )}
              ...
              >
                {uploading
                  ? <span className="flex items-center justify-center"><FaSpinner className="mr-2 animate-spin" /> Uploading...</span>
                  : 'Post'
                }
              </button>
            </div>
