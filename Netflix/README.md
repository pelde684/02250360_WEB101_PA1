...
For this assignment, I created a Netflix-inspired web application using React.js. The goal of the project was to recreate the basic look and feel of Netflix while applying the concepts we learned in class.
